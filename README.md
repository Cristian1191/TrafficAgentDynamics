...
- El repositorio contiene el núcleo en C++ y bindings Python para facilitar experimentos. Ver archivos principales del proyecto para detalles de implementación.
- Este README explica la intuición y el uso conceptual; la implementación concreta sigue las funciones y clases nombradas arriba.

```// filepath: c:\Users\Cris_\OneDrive\Desktop\Python\simulador_trafico\README.md
